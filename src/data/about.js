...
export const aboutSteps = [
  {
    ...
    image: campusOutdoor,
    alt: "Ariantika outdoors in a beige hijab and sunglasses, smiling with her arms open beside a stone wall on the university campus",
    caption: "Universitas Sumatera Utara campus",
  ...
  },
  {
    ...
    image: mphGraduation,
    alt: "Ariantika in a black hijab wearing a maroon graduation sash labeled Master of Public Health, Class of 2024, holding a bouquet in front of the Faculty of Public Health sign at Universitas Sumatera Utara",
    caption: "Master of Public Health graduation, USU, 2024",
  ...
  },
  {
    ...
    alt: "Ariantika in a white hijab and conference lanyard gesturing toward the 9th MABIP 2025 backdrop for the Malaysian Association for Bronchology and Interventional Pulmonology",
    caption: "9th MABIP Conference, 2025",
  ...
  },
  {
    ...
    alt: "Ariantika at a Genomics Science Day event, wearing a beige hijab, glasses, a white event shirt with UK International Development branding, a blue lanyard, and making a peace sign",
  ...
  },
  {
    ...
    alt: "Ariantika in a light blue hijab smiling while pointing at a museum exhibit panel about bacteria, with petri dish and microscopic images on the display",
    caption: "Microbiology exhibit, science museum",
...
// ---- about carousel ----
export const aboutCarousel = aboutCarouselStepIds
  .map((id) => aboutStepsById[id])
  .filter(Boolean)
